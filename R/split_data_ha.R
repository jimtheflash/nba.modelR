#' split data for preprocessing and modeling for separate home/away models
...
#' @return list
#' @export
split_data_ha <- function(data,
                         use_case = 'team_games',
                         tg_seas_type = 'Regular Season',
                         tg_nums = sort(c(1, 5, 11, 23)),
                         tg_testtrain_split_prop = 0.85) {
